...
abstract class FlutterFlowTheme {
  ...
  late Color fundo;
  late Color selecao;
  late Color componente;
  late Color proteina;
  late Color carboidrato;
  late Color lipidio;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color fundo = const Color(0xFFF5F7F5);
  late Color selecao = const Color(0xFF1F7A4A);
  late Color componente = const Color(0xFFF0F5F1);
  late Color proteina = const Color(0xFFB8FFDD);
  late Color carboidrato = const Color(0xFFFFF19A);
  late Color lipidio = const Color(0xFFFFAFB1);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color fundo = const Color(0xFF1D2428);
  late Color selecao = const Color(0xFF1F7A4A);
  late Color componente = const Color(0xFF1D2428);
  late Color proteina = const Color(0xFF367E58);
  late Color carboidrato = const Color(0xFFC28D00);
  late Color lipidio = const Color(0xFFFF637E);
}
